...
import static com.example.gamestore.constants.Validations.DESCRIPTION_SHOULD_BE_MIN_20_CHARACTERS;
...
public class GameToEditDTO {
    ...
    public GameToEditDTO(Long id, String title, String trailerId, String imageUrl, float size, BigDecimal price, String description, LocalDate releaseDate) {
        setId(id);
        setTitle(title);
    ...
    public Game toGame(){
        return new Game (id, title, trailerId, imageUrl, size, price, description, releaseDate);
    }
}
